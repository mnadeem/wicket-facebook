...
public class WicketApplication extends WebApplication implements IUnauthorizedComponentInstantiationListener {
	...
	public void onUnauthorizedInstantiation(Component component) {
		if (component instanceof Page) {
			...
			if (((FacebookSession) page.getSession()).isSessionValid()) {
				return;
			}
